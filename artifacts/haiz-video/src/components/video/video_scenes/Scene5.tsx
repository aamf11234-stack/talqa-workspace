...
export function Scene5() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center w-[80vw]">
        <motion.div
          ...
          className="text-[15vw] font-bold text-gradient-gold tabular-nums leading-none mb-[2vh] tracking-tighter drop-shadow-2xl"
        >
          ١٥٠٠+
        </motion.div>
        ...
        <motion.h2
          ...
          animate={phase >= 2 ? { y: 0, opacity: 1 } : { y: "5vh", opacity: 0 }}
          transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1] }}
          className="text-[6vw] font-display text-white drop-shadow-lg"
        >
          عضو في مجتمع حيز
        </motion.h2>
        ...
        <div className="absolute inset-0 pointer-events-none -z-10">
          {[...Array(15)].map((_, i) => (
            <motion.div
              key={i}
              className="absolute w-[5vw] h-[5vw] rounded-full border border-[var(--gold-dark)]/40 backdrop-blur-md bg-white/5 overflow-hidden"
              initial={{ 
