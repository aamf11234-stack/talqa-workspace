        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <motion.button
              ...
              className="flex items-center gap-3 px-8 py-4 rounded-xl font-bold text-lg text-white transition-all"
              style={{ background: 'linear-gradient(135deg,#0B4A6F,#00B4D8)', boxShadow: '0 8px 30px rgba(0,180,216,0.25)' }}
            >
              <Smartphone size={22} />
              جرّب التطبيق الآن
            </motion.button>
          ...
          >
            ...
            {/* Screen 3 (Front) — click opens modal */}
            <div
              onClick={() => setModalOpen(true)}
            ...
            >
              ...
              <div className="w-full h-full bg-[#050D1A] rounded-[2rem] p-5 pt-10 overflow-hidden relative">
                ...
                <div className="absolute inset-0 rounded-[2rem] bg-black/0 group-hover:bg-black/40 transition-all flex items-center justify-center">
                  <div className="opacity-0 group-hover:opacity-100 transition-opacity bg-white text-[#050D1A] font-bold px-5 py-2.5 rounded-xl flex items-center gap-2 text-sm">
                    <Smartphone size={16} />
                    جرّب التطبيق
                  </div>
                </div>
