...
const SEO: Record<string, { title: string; desc: string }> = {
  '/':                    { title: 'تلقا تك | تطبيقك الجوال بـ 499 ريال — iOS وAndroid وApple Wallet', desc: 'تطبيق iOS وAndroid + بطاقة Apple Wallet + لوحة تحكم بـ 499 ريال دفعة واحدة — كود ملكك. تلقا تك: شركة برمجة سعودية تسلّم في 3 أسابيع مع ضمان رضا.' },
