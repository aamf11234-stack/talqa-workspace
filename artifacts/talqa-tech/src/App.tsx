...
const SEO: Record<string, { title: string; desc: string }> = {
  '/':                    { title: 'تلقا تك | ابغى تطبيق؟ iOS وAndroid بـ 499 ريال', desc: 'ابغى تطبيق؟ تلقا تك تبنيه لك — iOS وAndroid وApple Wallet بـ 499 ريال دفعة واحدة. الكود ملكك، تسليم في 3 أسابيع، ضمان رضا كامل. ابدأ اليوم.' },
