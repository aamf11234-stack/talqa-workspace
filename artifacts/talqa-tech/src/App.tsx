...
const SEO: Record<string, { title: string; desc: string }> = {
  '/':                    { title: 'تلقا تك | شركة تطوير تطبيقات جوال وApple Wallet في السعودية', desc: 'تلقا تك — شركة برمجة سعودية: تطبيقات iOS وAndroid، بطاقات Apple Wallet، مواقع احترافية، وأنظمة مخصصة. تسليم في ٣ أسابيع مع ضمان رضا كامل.' },
  '/services':            { title: 'خدمات تطوير التطبيقات والمواقع | تلقا تك', desc: 'تطوير تطبيقات iOS وAndroid، بطاقات Apple Wallet، مواقع إلكترونية سريعة، وأنظمة حجوزات متكاملة — كل ما يحتاجه مشروعك التجاري.' },
  '/pricing':             { title: 'أسعار تطوير التطبيقات والمواقع | تلقا تك', desc: 'أسعار واضحة وشفافة لتطوير التطبيقات والمواقع — تبدأ من ٤٩٩ ريال. لا رسوم مخفية، كود ملكك بالكامل.' },
  ...
  '/food':                { title: 'تطبيق جوال للمطعم أو الكافيه | تلقا تك — ٤٩٩ ريال', desc: 'تطبيق iOS وAndroid كامل للمطاعم والكافيهات: Apple Wallet، قائمة QR، طلب وتوصيل، نقاط ولاء — بـ٤٩٩ ريال دفعة واحدة.' },
