...
import {
  ...
  Tag, DollarSign, Trophy, Heart, Dumbbell, Scissors,
  Building2, Package, Car, Stethoscope, BookOpen,
  Utensils, CreditCard, MessageSquare,
} from 'lucide-react';

const WA = 'https://wa.me/966551378531?text=السلام%20عليكم%2C%20أبي%20تطبيق%20جوال%20احترافي%20بـ499%20ريال';
const WA_ICON = (
...
/* ══════════════════════════════════
   APP CATEGORIES — any business, any idea
══════════════════════════════════ */
const APP_TYPES = [
  { Icon: Coffee,        label: 'كافيهات وبن',     color: '#F59E0B' },
  { Icon: Utensils,      label: 'مطاعم',            color: '#EF4444' },
  { Icon: Stethoscope,   label: 'عيادات',           color: '#10B981' },
  { Icon: Dumbbell,      label: 'نوادٍ رياضية',     color: '#F97316' },
  { Icon: Scissors,      label: 'صالونات',          color: '#EC4899' },
  { Icon: ShoppingBag,   label: 'متاجر',            color: '#8B5CF6' },
  { Icon: Building2,     label: 'شركات',            color: '#3B82F6' },
  { Icon: Heart,         label: 'صيدليات',          color: '#06B6D4' },
  { Icon: Car,           label: 'توصيل',            color: '#84CC16' },
  { Icon: BookOpen,      label: 'تعليم',            color: '#A78BFA' },
  { Icon: Package,       label: 'لوجستيات',         color: '#FB923C' },
  { Icon: MessageSquare, label: 'أي فكرة أخرى',     color: '#6366F1' },
];
  ...
  return (
    <div style={{ direction: 'rtl' }}>
      ...
      <div style={{ padding: '12px', borderRadius: 14, background: `linear-gradient(135deg,${color}22,${color}0d)`,
        ...
        <div style={{ fontSize: 28, fontWeight: 900, color, letterSpacing: -2, lineHeight: 1 }}>٢٤٧</div>
  ...
  return (
    <div style={{ direction: 'rtl' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
        ...
        <span style={{ fontSize: 9, color, fontWeight: 700, fontFamily: 'Cairo,sans-serif' }}>الأحد ٢٠ يوليو</span>
      </div>
      ...
      {slots.map((sl, i) => (
        <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 10px',
          ...
          <span style={{ fontSize: 9, fontWeight: 800, color, fontFamily: 'monospace', width: 30 }}>{sl.t}</span>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px', position: 'relative', zIndex: 1 }}>
        ...
        <motion.div initial={{ opacity: 0, y: 28 }} whileInView={{ opacity: 1, y: 0 }}
          ...
          <p style={{ fontSize: 16.5, color: 'rgba(255,255,255,0.42)', maxWidth: 560,
            ...
            كافيه، عيادة، متجر، صالون، شركة — أي قطاع وأي فكرة. تطبيق بهويتك الكاملة، جاهز على App Store و Google Play.
          </p>
          ...
          <motion.div
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', gap: 4 }}>
                <span style={{ fontFamily: 'Cairo,sans-serif', fontWeight: 900, fontSize: 52,
                  color: '#fff', letterSpacing: -2, lineHeight: 1 }}>499</span>
                <span style={{ fontFamily: 'Cairo,sans-serif', fontWeight: 700, fontSize: 18,
                  color: '#A78BFA' }}>ريال</span>
              </div>
              <div style={{ fontFamily: 'Cairo,sans-serif', fontWeight: 700, fontSize: 12,
                color: 'rgba(255,255,255,0.4)', marginTop: 4 }}>شامل iOS وAndroid</div>
            </div>

            <div style={{ width: 1, height: 60, background: 'rgba(255,255,255,0.1)', flexShrink: 0 }}/>

            <div style={{ display: 'flex', flexDirection: 'column', gap: 8, textAlign: 'right' }}>
              {['تطبيق iOS وAndroid من كودبيس واحد', 'بهويتك — شعارك وألوانك واسمك', 'لوحة تحكم ويب كاملة', 'دعم ٣ أشهر بعد الإطلاق مجاناً'].map(f => (
                <div key={f} style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  <div style={{ width: 16, height: 16, borderRadius: 4, background: 'rgba(167,139,250,0.2)',
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              ...
              <a href={WA} target="_blank" rel="noreferrer" style={{
                ...
                fontFamily: 'Cairo,sans-serif', fontWeight: 800, fontSize: 13, color: '#fff',
              }}>
                {WA_ICON}
                واتساب
              </a>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10, justifyContent: 'center', maxWidth: 800, margin: '0 auto' }}>
            {APP_TYPES.map(({ Icon, label, color }, i) => (
              <motion.div key={i}
                ...
                <span style={{ fontFamily: 'Cairo,sans-serif', fontWeight: 700, fontSize: 13, color: 'rgba(255,255,255,0.75)' }}>{label}</span>
              </motion.div>
            ))}
          </div>
        </motion.div>
        ...
        {/* ── SCREEN TABS ── */}
        <div style={{ textAlign: 'center', marginBottom: 24 }}>
          <span style={{ fontFamily: 'Cairo,sans-serif', fontWeight: 800, fontSize: 15, color: 'rgba(255,255,255,0.6)' }}>
            استكشف ما يشمله التطبيق
          </span>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: m ? '1fr' : '1fr 1fr 1fr', gap: m ? 24 : 32, alignItems: 'start', marginBottom: 64 }}>
            ...
            <div style={{ display: 'flex', gap: 8, justifyContent: 'center', marginTop: 18 }}>
              {['App Store', 'Google Play'].map(b => (
                <div key={b} style={{
                  ...
                  <div>
                    <div style={{ fontFamily: 'sans-serif', fontSize: 8, color: 'rgba(255,255,255,0.35)', letterSpacing: 0.5 }}>AVAILABLE ON</div>
                    <div style={{ fontFamily: 'sans-serif', fontWeight: 800, fontSize: 11, color: '#fff' }}>{b}</div>
                  </div>
                </div>
              ))}
            </div>
          ...
          <motion.div initial={{ opacity: 0, x: 24 }} whileInView={{ opacity: 1, x: 0 }}
            ...
            {[
              ...
              { Icon: TrendingUp,c: '#A78BFA', t: 'دعم ٣ أشهر مجاناً', b: 'ما تسلّم وتوداعنا — نتابع معك حتى النجاح.' },
            ].map((t, i) => (
