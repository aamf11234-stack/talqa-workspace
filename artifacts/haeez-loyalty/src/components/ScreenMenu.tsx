...
const menu: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'موهيتو روز بيري',        desc: 'موهيتو وردي بنعناع وتوت طازج',           price: 17, badge: 'الأشهر', badgeColor: '#3D7A6A', featured: true, img: `${B}bd-mohito.jpg` },
      { name: 'موهيتو بيريز ليمون',    desc: 'بيري وليمون طازج — توازن منعش مثالي',    price: 17 },
      ...
      { name: 'ايس بيري',               desc: 'بيري بارد بنكهة التوت المميزة',            price: 19 },
