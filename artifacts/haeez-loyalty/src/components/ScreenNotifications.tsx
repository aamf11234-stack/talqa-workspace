...
const notifications: Notif[] = [
  ...
  },
  {
    ...
    body: 'من فريق النشاط — مشروبك الأول اليوم مجاني، وهدية مفاجئة بانتظارك عند الصندوق!',
    time: 'أمس',
    unread: false,
  },
  {
      ...
      <div className="flex-1 overflow-y-auto scrollbar-none pb-24">
        ...
        <div className="mx-5 mt-2 mb-4 p-4 rounded-[18px] flex items-center gap-3"
          ...
          <div className="shrink-0">
            <img src={logoImg} alt={brand.name} className="w-9 h-9 rounded-[11px] object-cover"
              style={{ border: '1px solid rgba(201,149,106,0.2)' }} />
          </div>
          <div className="flex-1">
            <p className="text-[11px] font-bold text-[#111]">إشعارات {brand.name}</p>
